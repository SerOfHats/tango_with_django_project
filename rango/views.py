    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            if user.is_active:
                ...
                return HttpResponse("Your Rango account is disabled. Please create a new account"
                                    "or contact the staff to inquire as to the reasons"
                                    "your account has been disabled.")
        else:
            # Bad login details were provided. So we can't log the user in.
            print("Invalid login details: {0}, {1}".format(username, password))
            return HttpResponse("Invalid login details supplied. Either username or password"
